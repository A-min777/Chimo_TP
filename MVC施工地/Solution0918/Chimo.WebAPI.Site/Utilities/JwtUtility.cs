...
public class JwtUtility
{
    public static string GenerateToken(Member member )
    {
        ...
        var claims = new[]
        {
            ...
            new Claim("Point", member.Point.ToString()),
            new Claim("ProfileImage", member.ProfileImage ?? string.Empty),
    ...
    public static Member DecodeToken(string token)
    {
        ...
        var member = new Member
        {
            ...
            Point = int.Parse(jwtToken.Claims.FirstOrDefault(c => c.Type == "Point")?.Value),
            ProfileImage = jwtToken.Claims.FirstOrDefault(c => c.Type == "ProfileImage")?.Value,
